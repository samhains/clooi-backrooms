...
export default {
    ...
    cliOptions: {
        ...
        claudeOptions: modelConfig.company === 'anthropic' ? modelConfig.defaultOptions : {},
        chatGptOptions: modelConfig.company === 'openai' ? modelConfig.defaultOptions : {},
        bingOptions: modelConfig.company === 'microsoft' ? modelConfig.defaultOptions : {},
    },
    bingAiClient: {
